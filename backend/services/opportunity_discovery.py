...
def discover_scenario_opportunities(
    ...
    if scenario_type == "TRAPPED_CARGO":
        ...
        opportunities.append(NetworkOpportunity(
            ...
            destination=f"Fujairah Terminal → {destination_port}",
        ...
        opportunities.append(NetworkOpportunity(
            ...
            destination=f"Gulf Refiner (resale for {destination_port} req)",
    ...
    # ═══════════════════════════════════════════════════════════════════════════
        ...
        opportunities.append(NetworkOpportunity(
            ...
            destination=f"West Coast Refinery (rebalanced for {destination_port})",
            volume_bbls=required_volume,
    ...
    # ═══════════════════════════════════════════════════════════════════════════
        ...
        opportunities.append(NetworkOpportunity(
            ...
            origin="Moving Vessel (Current Position)",
            destination=f"Fujairah / Salalah Hub → {destination_port}",
            volume_bbls=required_volume,
