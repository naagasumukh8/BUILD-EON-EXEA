...
function LandingContent() {
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#18181B] flex flex-col font-sans selection:bg-[#18181B] selection:text-white">
      <Navbar />
      ...
      <main className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 max-w-6xl w-full mx-auto py-12 sm:py-20 space-y-16 sm:space-y-24">
        ...
        <div className="text-center space-y-6 max-w-4xl">
          ...
          {/* Status Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#18181B]/10 text-xs font-medium text-[#18181B] shadow-2xs">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/map"
              className="w-full sm:w-auto rounded-full bg-white border border-[#18181B]/10 px-8 py-4 text-sm font-semibold text-[#18181B] hover:bg-[#FAFAF8] transition-all"
            >
